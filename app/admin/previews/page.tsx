      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="space-y-3 w-full max-w-4xl px-8">
          ...
          <div className="grid grid-cols-3 gap-2 mt-8">
            {[...Array(9)].map((_, i) => <div key={i} className="aspect-[3/4] bg-th-fg/[0.03] animate-pulse" />)}
          </div>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen">
      <header className="border-b border-th-fg/[0.06] px-8 py-5 flex items-center justify-between sticky top-0 bg-th-surface/95 backdrop-blur-sm z-10">
        <div className="flex items-center gap-4">
          ...
          <span className="text-th-fg/25 text-[10px] tracking-[0.3em] uppercase">Previews</span>
        </div>
        <Link
          href="/portfolios"
          target="_blank"
      ...
      <div className="max-w-7xl mx-auto px-8 py-10">
        <div className="flex items-end justify-between mb-8">
          <div>
            <p className="text-th-fg/20 text-[10px] tracking-[0.5em] uppercase mb-2">Previews</p>
            ...
            <p className="text-th-fg/10 text-xs mt-1">
        ...
        >
          <p className="text-th-fg/30 text-xs tracking-wide">Drop preview images here or click Upload</p>
        </div>
