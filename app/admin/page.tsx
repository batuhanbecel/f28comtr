    ...
    <div className="min-h-screen">
      <header className="border-b border-th-fg/[0.06] px-8 py-5 flex items-center justify-between sticky top-0 bg-th-surface/95 backdrop-blur-sm z-10">
        <div className="flex items-center gap-4">
          ...
          <div className="w-px h-4 bg-th-fg/10" />
          <span className="text-th-fg/25 text-[10px] tracking-[0.4em] uppercase">Dashboard</span>
        </div>
      </header>
      ...
      <div className="max-w-7xl mx-auto px-8 py-12">
        ...
        <div className="mb-8">
          <div className="flex items-end justify-between mb-6">
            <div>
              <p className="text-th-fg/20 text-[10px] tracking-[0.5em] uppercase mb-2">Roster</p>
